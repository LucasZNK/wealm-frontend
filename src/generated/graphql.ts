...
export type FindAllQuery = {
  __typename?: 'Query';
  findAll: Array<{ __typename?: 'User'; username: string }>;
};
...
export function getSdk(
  ...
  return {
    ...
    ): Promise<FindAllQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<FindAllQuery>(FindAllDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'findAll',
    ...
    getInvestment(
      ...
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<GetInvestmentQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<GetInvestmentQuery>(GetInvestmentDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getInvestment',
